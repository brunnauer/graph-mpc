...
// std::vector<Ring> clip::equals_zero(Party id, RandomGenerators &rngs, std::shared_ptr<io::NetIOMP> network, std::vector<Ring> &input_share) {
// const size_t n_layers = 5;
...
// std::vector<Ring> clip::equals_zero_two(Party id, RandomGenerators &rngs, std::shared_ptr<io::NetIOMP> network, size_t n, std::vector<Ring> &input_share) {
...
// std::vector<Ring> clip::B2A(Party id, RandomGenerators &rngs, std::shared_ptr<io::NetIOMP> network, std::vector<Ring> &input_share) {
