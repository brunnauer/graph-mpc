...
std::vector<Row> sort::apply_perm(ProtocolConfig &conf, Permutation &perm, std::vector<Row> &input_share) {
...
std::vector<Row> sort::switch_perm(ProtocolConfig &conf, Permutation &p1, Permutation &p2, std::vector<Row> &input_share) {
